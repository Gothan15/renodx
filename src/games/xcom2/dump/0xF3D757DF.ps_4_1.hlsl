...
Texture3D<float4> XComFOWVolumeTexture : register(t3);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.z = PixelTexture2D_2.SampleBias(PixelTexture2D_2_s, r0.zw, 0).x;
  r1.xy = r0.xy * float2(2,0.5) + UniformPixelVector_3.xy;
  r0.xyw = PixelTexture2D_1.SampleBias(PixelTexture2D_1_s, r0.xy, 0).xyz;
  r1.x = PixelTexture2D_2.SampleBias(PixelTexture2D_2_s, r1.xy, 0).x;
  r0.z = r1.x * r0.z;
  r0.z = 10 * r0.z;
  r1.x = log2(abs(OcclusionPercentage));
  r1.x = UniformPixelScalars_0.x * r1.x;
  r1.x = exp2(r1.x);
  r1.x = 1 + -r1.x;
  r1.y = cmp(abs(OcclusionPercentage) < 9.99999997e-07);
  r1.x = r1.y ? 1 : r1.x;
  r1.y = PixelTexture2D_0.SampleBias(PixelTexture2D_0_s, v2.xy, 0).y;
  r1.x = r1.y * r1.x;
  r0.xyw = r1.xxx * r0.xyw;
  r0.xyw = r1.xxx * float3(0.200000003,0.200000003,0.200000003) + r0.xyw;
