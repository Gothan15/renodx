...
struct ShaderInjectData {
  ...
  float custom_fow_mode;
  float custom_cubemap_mode;
  float tone_map_hdr_video;
  float tone_map_video_nits;
  float custom_dirty_lens_strength;
...
#define CUSTOM_FOW_MODE                          shader_injection.custom_fow_mode
...
#define CUSTOM_CUBEMAP_MODE                      shader_injection.custom_cubemap_mode
#define CUSTOM_DIRTY_LENS_STRENGTH               shader_injection.custom_dirty_lens_strength
