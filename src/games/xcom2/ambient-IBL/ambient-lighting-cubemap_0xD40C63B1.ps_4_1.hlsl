  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.w = log2(r1.w);
  r1.xyzw = float4(-1,1,-1,0.550000012) * r1.xyzw;
  r1.w = exp2(r1.w);
  r1.w = 1 + -r1.w;
  r0.x = r0.x ? r1.w : r4.w;
  float roughness = r0.x;
  r1.w = AmbientIntensity.z * r0.x;
  r2.y = 1 + -r0.x;
  r2.xy = EnvBRDFTexture.Sample(EnvBRDFTexture_s, r2.xy).xy;
  r2.xyz = r4.xyz * r2.xxx + r2.yyy;
  r1.xyz = AmbientCubemap.SampleLevel(AmbientCubemap_s, r1.xyz, r1.w).xyz;
  r1.xyz = AmbientIntensity.yyy * r1.xyz;
  r1.xyz = r1.xyz * r2.xyz;
  r2.xyz = CharSpecAndDiffMod.yyy * r1.xyz;
