...
// ---- Created with 3Dmigoto v1.4.1 on Mon Jan 12 05:21:04 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.x = saturate(r0.x);  // Keep saturate - this is for text alpha, needs 0-1
  r1.x = log2(r1.x);
  r1.x = inv_gamma * r1.x;
  r1.w = exp2(r1.x);
  r1.xyz = float3(1,1,1);
  ...
  r1.x = sin(r1.x);
  r1.yzw = (RENODX_TONE_MAP_TYPE != 0) ? float3(3,3,3) * r0.xyz : saturate(float3(3,3,3) * r0.xyz);  // Remove saturate for HDR
