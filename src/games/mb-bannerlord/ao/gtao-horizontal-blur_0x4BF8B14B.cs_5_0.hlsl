...
void main(uint3 vThreadID : SV_DispatchThreadID)
{
  ...
  r3.xyz = t0.SampleLevel(s1_s, r2.yz, 0).xyz;
  r1.w = dot(r3.yz, float2(0.996108949,0.00389105058));
  r1.w = 300 * r1.w;
  r1.z = r1.z * 300 + -r1.w;
  r1.z = cmp(abs(r1.z) < 0.100000001);
  r2.y = r1.z ? 1.000000 : 0;
  r1.z = r1.z ? 0.624945998 : 0.383103013;
  r2.x = r2.x * r2.y;
  r2.x = 0.241843 * r2.x;
  r2.x = r3.x * 0.383103013 + r2.x;
  r4.xyzw = r1.xyxy * float4(1,0,-2,0) + r0.xyxy;
  r4.xyzw = max(float4(0,0,0,0), r4.xyzw);
  r4.xyzw = min(r4.xyzw, r0.zwzw);
  r2.yzw = t0.SampleLevel(s1_s, r4.xy, 0).xyz;
  ...
  r2.y = dot(r4.yz, float2(0.996108949,0.00389105058));
  r2.y = r2.y * 300 + -r1.w;
  ...
  r4.xyzw = r1.xyxy * float4(2,0,-3,0) + r0.xyxy;
  r0.xy = r1.xy * float2(3,0) + r0.xy;
  r0.xy = max(float2(0,0), r0.xy);
  r0.xy = min(r0.xy, r0.zw);
  r2.yzw = t0.SampleLevel(s1_s, r0.xy, 0).xyz;
  r4.xyzw = max(float4(0,0,0,0), r4.xyzw);
  r0.xyzw = min(r4.xyzw, r0.zwzw);
  r4.xyz = t0.SampleLevel(s1_s, r0.xy, 0).xyz;
  r0.xyz = t0.SampleLevel(s1_s, r0.zw, 0).xyz;
  r0.w = dot(r4.yz, float2(0.996108949,0.00389105058));
  r0.w = r0.w * 300 + -r1.w;
